...
hl_t, pval_t = hosmer_lemeshow_test(truth,data,results,Q = 10)
...
print('base')
print('hl = %.3f, p = %.5f' %(hl_b,pval_b)) 

print('truth')
print('hl = %.3f, p = %.5f' %(hl_t,pval_t)) 

print('min')
print('hl = %.3f, p = %.5f' %(hl_min,pval_min)) 

print('max')
print('hl = %.3f, p = %.5f' %(hl_max,pval_max)) 
